...
- [1. Infra](#1-infra)
  - [1.1. Infra - Edge](#11-infra---edge)
    - [1.1.1. Expand Windows AI APIs to more PCs](#111-expand-windows-ai-apis-to-more-pcs)
    - [1.1.2. Aion 1.0 Instruct and Aion 1.0 Plan](#112-aion-10-instruct-and-aion-10-plan)
    - [1.1.3. Surface RTX Spark, Dev Box](#113-surface-rtx-spark-dev-box)
    - [1.1.4. Demo: Surface RTX Spark - Dev Tools](#114-demo-surface-rtx-spark--dev-tools)
    - [1.1.5. Windows 365 is dev maxed](#115-windows-365-is-dev-maxed)
  - [1.2. Infra - Cloud](#12-infra---cloud)
    - [1.2.1. Data Center](#121-data-center)
    - [1.2.2. First-party Silicon](#122-first-party-silicon)
    - [1.2.3. First-party CPU](#123-first-party-cpu)
    - [1.2.4. Satya with Jensen Huang (NVIDIA)](#124-satya-with-jensen-huang-nvidia)
  - [1.3. Device - Project Solara (form factors)](#13-device---project-solara-form-factors)
    - [1.3.1. Steven Bathiche's intro about Project Solara](#131-steven-bathiches-intro-about-project-solara)
    - [1.3.2. Satya with Christiano Amon (Qualcomm)](#132-satya-with-christiano-amon-qualcomm)
- [2. Models / Context / Tools](#2-models--context--tools)
  - [2.1. Models](#21-models)
  - [2.2. Context - Data Layer](#22-context---data-layer)
    - [2.2.1. Horizon DB](#221-horizon-db)
    - [2.2.2. GPU Accelerated Fabric DW](#222-gpu-accelerated-fabric-dw)
  - [2.3. Context - IQ Layer](#23-context--iq-layer)
    - [2.3.1. Web IQ](#231-web-iq)
    - [2.3.2. Microsoft IQ](#232-microsoft-iq)
    - [2.3.3. Demo: Agents on Microsoft IQ](#233-demo-agents-on-microsoft-iq)
- [3. Agent Runtime](#3-agent-runtime)
  - [3.1. Windows - Agent Runtime](#31-windows--agent-runtime)
    - [3.1.1. Microsoft Execution Containers (MXC)](#311-microsoft-execution-containers-mxc)
    - [3.1.2. OpenClaw runs on Windows](#312-openclaw-runs-on-windows)
    - [3.1.3. Demo: Openclaw on Windows](#313-demo-openclaw-on-windows)
    - [3.1.4. Peter Steinberger Talk](#314-peter-steinberger-talk)
  - [3.2. Foundry - Agent Runtime](#32-foundry--agent-runtime)
    - [3.2.1. Foundry-hosted Agent](#321-foundry-hosted-agent)
    - [3.2.2. Fireworks AI on Foundry](#322-fireworks-ai-on-foundry)
    - [3.2.3. GitHub Copilot App](#323-github-copilot-app)
    - [3.2.4. Rayfin SDK](#324-rayfin-sdk)
    - [3.2.5. Replit and Microsoft Partnership](#325-replit-and-microsoft-partnership)
    - [3.2.6. Demo: GitHub Copilot App](#326-demo-github-copilot-app)
- [4. Observability & Governance & Security](#4-observability--governance--security)
  - [4.1. Security for AI](#41-security-for-ai)
    - [4.1.1. Agent 365 SDK](#411-agent-365-sdk)
    - [4.1.2. Agent 365 to Secure Local Agents and Claws](#412-agent-365-to-secure-local-agents-and-claws)
    - [4.1.3. Demo: Foundry and Agent 365](#413-demo-foundry-and-agent-365)
  - [4.2. Security with AI](#42-security-with-ai)
    - [4.2.1. Multi-model Agentic Security System (MDASH)](#421-multi-model-agentic-security-system-mdash)
    - [4.2.2. Demo: MDASH (multi-model agentic security)](#422-demo-mdash-multi-model-agentic-security)
  - [Transit: Alex Pall and Drew Taggart (Chainsmokers)](#transit-alex-pall-and-drew-taggart-chainsmokers)
  - [4.3. Frontier Opportunities for Companies](#43-frontier-opportunities-for-companies)
    - [4.3.1. Copilot and Autopilot](#431-copilot-and-autopilot)
- [5. Reinforcement Learning Environment](#5-reinforcement-learning-environment)
- [6. Microsoft AI Update](#6-microsoft-ai-update)
  - [6.1. Family of MAI models](#61-family-of-mai-models)
  - [6.2. MAI Models as Foundation of Microsoft Frontier Tuning](#62-mai-models-as-foundation-of-microsoft-frontier-tuning)
  - [6.3. Microsoft Partnership with Mayo Clinic & New Frontier Model for Health](#63-microsoft-partnership-with-mayo-clinic--new-frontier-model-for-health)
  - [6.4. Demo: Frontier Tuning](#64-demo-frontier-tuning)
- [7. Microsoft Discovery](#7-microsoft-discovery)
- [8. Microsoft Quantum](#8-microsoft-quantum)
  - [8.1. Majorana 2](#81-majorana-2)

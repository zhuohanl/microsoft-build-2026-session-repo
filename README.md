...
| BRK251 - Build secure and enterprise-ready agents with Agent 365 | [`BRK251-build-secure-and-enterprise-ready-agents-with-agent-365/brk251_build_secure_and_enterprise_ready_agents_with_agent_365.md`](BRK251-build-secure-and-enterprise-ready-agents-with-agent-365/brk251_build_secure_and_enterprise_ready_agents_with_agent_365.md) |
| OD840 - Enable agents for enterprises using Agent 365 SDK | [`OD840-enable-agents-for-enterprises-using-agent-365-sdk/od840_enable_agents_for_enterprises_using_agent_365_sdk.md`](OD840-enable-agents-for-enterprises-using-agent-365-sdk/od840_enable_agents_for_enterprises_using_agent_365_sdk.md) |
...
![Yina recommended sessions](hover-notes-images/screenshot-01KV4J17GNNSQGR2B3J8CF6WS6.png)

### Tina recommended sessions

![Tina recommended sessions](hover-notes-images/screenshot-01KV4S8CCBZ9RFFVZNDA36XB17.png)